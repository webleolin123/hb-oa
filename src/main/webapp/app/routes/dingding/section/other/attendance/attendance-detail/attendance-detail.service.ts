...
import {
    WORKFLOW_TO_ATTENDANCE_KEYCODE_API,
...
export class AttendanceDetailService {
    ...
    private resourceUrl = WORKFLOW_TO_ATTENDANCE_KEYCODE_API;
    private resourceUrl_search = WORKFLOW_TO_ATTENDANCE_DETAIL_SEARCH_API;
