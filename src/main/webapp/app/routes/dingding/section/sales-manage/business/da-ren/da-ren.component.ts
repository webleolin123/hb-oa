...
import {DaRenDetailComponent} from "./detail/da-ren-detail.component";
@Component({
    selector: 'da-ren',
    templateUrl: './da-ren.component.html',
})
export class DaRenComponent implements OnInit {
    daRens: DaRen[];
    ...
    check(id) {
        this.modal
            .static(DaRenDetailComponent, {parentData: {id: id}})
