...
export class MessageComponent implements OnInit {
    ...
    search(init: boolean = true) {
        ...
        this.messageService.search({
            ...
            smsType:this.searchItem_applyType,
    ...
    check(id) {
        this.modal
            .static(MessageDetailComponent, {parentData: {id: id}})
