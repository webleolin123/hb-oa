...
import {TaoKeDetailComponent} from "./detail/tao-ke-detail.component";
@Component({
    selector: 'tao-ke',
    templateUrl: './tao-ke.component.html',
})
export class TaoKeComponent implements OnInit {
    taoKes: TaoKe[];
    ...
    check(id) {
        this.modal
            .static(TaoKeDetailComponent, {parentData: {id: id}})
