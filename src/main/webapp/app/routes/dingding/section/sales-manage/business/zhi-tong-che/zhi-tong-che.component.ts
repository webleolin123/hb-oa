...
import {ZhiTongCheDetailComponent} from "./detail/zhi-tong-che-detail.component";
@Component({
    selector: 'zhi-tong-che',
    templateUrl: './zhi-tong-che.component.html',
})
export class ZhiTongCheComponent implements OnInit,OnDestroy {
    zhiTongChes: ZhiTongChe[];
    ...
    check(id) {
        this.modal
            .static(ZhiTongCheDetailComponent, {parentData: {id: id}})
