...
import {ZuanZhanDetailComponent} from "./detail/zuan-zhan-detail.component";

@Component({
    selector: 'zuan-zhan',
    templateUrl: './zuan-zhan.component.html',
})
export class ZuanZhanComponent implements OnInit{
    zuanZhans: ZuanZhan[];
    ...
    check(id) {
        this.modal
            .static(ZuanZhanDetailComponent, {parentData: {id: id}})
