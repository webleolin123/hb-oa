...
import {CouponsDetailComponent} from "../..";
@Component({
  selector: 'coupons',
...
export class CouponsComponent implements OnInit{
    ...
    search(init: boolean = true) {
        ...
        this.couponsService.search({
            ...
            applyType: this.searchItem_couponType ,
    ...
    check(id) {
        this.modal
            .static(CouponsDetailComponent, {parentData: {id: id}})
