...
import {FullReduceDetailComponent} from "./detail/full-reduce-detail.component";
@Component({
  selector: 'full-reduce',
  templateUrl: './full-reduce.component.html',
})
export class FullReduceComponent implements OnInit{
    reduces: FullReduce[];
    ...
    search(init: boolean = true) {
        ...
        this.isSearch=true;
        this.fullReduceService.search({
            shopName: this.commonMethodsService.myTrim('besides',this.searchItem_shopName),
            reducePrice: this.commonMethodsService.myTrim('besides',this.searchItem_reducePrice),
            limitPrice: this.commonMethodsService.myTrim('besides',this.searchItem_limitPrice),
            applyReason: this.commonMethodsService.myTrim('besides',this.searchItem_applicantReason),
    ...
    check(id) {
        this.modal
            .static(FullReduceDetailComponent, {parentData: {id: id}})
