...
import {StockTransferDetailComponent} from "./detail/stock-transfer-detail.component";
@Component({
  selector: 'stock-transfer',
  templateUrl: './stock-transfer.component.html',
})
export class StockTransferComponent implements OnInit {
    stocks: StockTransferModel[];
    ...
    check(id) {
        this.modal
            .static(StockTransferDetailComponent, {parentData: {id: id}})
            .subscribe(() => {//回调函数 重新请求新数据
                this.loadAll();
        });
    }
